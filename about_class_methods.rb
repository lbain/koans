...
class AboutClassMethods < Neo::Koan
  ...
  # I like the self. mostly because that's what I've used before, but also
  # becuase then each class method is declared as a class method

  # Are there times you might prefer one over the other?
  # if you had a bunch of class methods you needed to write the << self way
