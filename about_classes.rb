...
class AboutClasses < Neo::Koan
  ...
  def test_args_to_new_must_match_initialize
    ...
    # THINK ABOUT IT:
    # Why is this so?
    # the initial_name wasn't declared as optional
  end
  ...
  def test_all_objects_support_to_s_and_inspect
    ...
    assert_equal "STRING", "STRING".to_s # since the string is already a string, no change
    assert_equal "\"STRING\"", "STRING".inspect # inspect needs to show it's a string, explicit ""
  end
