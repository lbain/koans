...
class AboutIteration < Neo::Koan
  ...
  def test_inject_will_blow_your_mind
    ...
    # Use the inject parameter as the base, assign it to the first block variable (sum)
    # iterate over the array, for each item, execute the block with the answer from the
    # pervious iteration as the first block variable (again, starting with the inject var)
    # http://stackoverflow.com/a/710514/863846
  end
  ...
  # There's no need to reference the file again (?)
