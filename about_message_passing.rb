...
class AboutMessagePassing < Neo::Koan
  ...
  def test_send_with_underscores_will_also_send_messages
    ...
    # someone may overwrite send by mistake, but they're unlikely to do so with __send__
    # http://stackoverflow.com/a/4658359/863846
  end
  ...
  def test_calling_method_missing_causes_the_no_method_error
    ...
    # method_missing wouldn't be a missing method and the NoMethodError
    # wouldn't get raised.
    #
    # NOTE:
    #
