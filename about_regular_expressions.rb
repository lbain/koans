...
class AboutRegularExpressions < Neo::Koan
  ...
  # Why?
  # they go as far as they can without failing before they finish
  ...
  def test_sub_is_like_find_and_replace
    ...
    # take the string "one two-three"
    # find things that match /(t\w*)/ --> "two", "three"
    # of those things, pick the first one --> "two"
    # and apply the string manipulation [0,1] to it --> "t"
    # now return the original string with that change --> "one t-three"
  end
